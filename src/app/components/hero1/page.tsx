...
const Hero1 = () => {
  return (
    <div className="xl:flex overflow-hidden">
      ...
      ></Image>
      <div className="w-full relative top-14 left-3 sm:left-7 font-extrabold text-sky-950">
        <h1 className="text-6xl ">Governor Sindh</h1>
        <h2 className="text-[40px] font-thin  ">Kamran Khan Tessori</h2>
        ...
        <div className="sm:flex sm:space-x-10 py-4 space-y-4 sm:space-y-0">
          <button className="px-32 sm:px-11 py-4 rounded-3xl text-white bg-sky-950 sm:rounded-lg hover:translate-y-2 transform transition-all duration-300 text-sm sm:text-lg">
            APPLY NOW
          </button>
